...
public sealed class AddRepositoryFunctionsMigration : Migration
{
    ...
    private const string UpPostFunctionPrefix = "SftpSync.Infrastructure.Migrations.Schema.Functions.202605280001_AddRepositoryFunctions.Up.Post.";
    private const string DownPreFunctionPrefix = "SftpSync.Infrastructure.Migrations.Schema.Functions.202605280001_AddRepositoryFunctions.Down.Pre.";
