...
{
    private const string UpScript = "SftpSync.Infrastructure.Migrations.Schema.202605270002_AddUiSupportIndexes_up.sql";
    private const string DownScript = "SftpSync.Infrastructure.Migrations.Schema.202605270002_AddUiSupportIndexes_down.sql";
