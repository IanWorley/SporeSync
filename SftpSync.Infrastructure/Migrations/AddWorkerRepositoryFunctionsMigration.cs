...
public sealed class AddWorkerRepositoryFunctionsMigration : Migration
{
    ...
    private const string UpPostFunctionPrefix = "SftpSync.Infrastructure.Migrations.Schema.Functions.202605300001_AddWorkerRepositoryFunctions.Up.Post.";
    private const string DownPreFunctionPrefix = "SftpSync.Infrastructure.Migrations.Schema.Functions.202605300001_AddWorkerRepositoryFunctions.Down.Pre.";
