...
public sealed class ExtendQueueItemProjectionsForGroupingMigration : Migration
{
    ...
    private const string UpPostFunctionPrefix = "SftpSync.Infrastructure.Migrations.Schema.Functions.202605290003_ExtendQueueItemProjectionsForGrouping.Up.Post.";
    private const string DownPreFunctionPrefix = "SftpSync.Infrastructure.Migrations.Schema.Functions.202605290003_ExtendQueueItemProjectionsForGrouping.Down.Pre.";
