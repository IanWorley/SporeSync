...
public sealed class MarkRemoteDeletedQueueItemsMigration : Migration
{
    ...
    private const string UpPostFunctionPrefix = "SftpSync.Infrastructure.Migrations.Schema.Functions.202605300002_MarkRemoteDeletedQueueItems.Up.Post.";
    private const string DownPreFunctionPrefix = "SftpSync.Infrastructure.Migrations.Schema.Functions.202605300002_MarkRemoteDeletedQueueItems.Down.Pre.";
