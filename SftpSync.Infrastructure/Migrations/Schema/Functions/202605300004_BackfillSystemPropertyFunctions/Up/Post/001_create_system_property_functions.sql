CREATE OR REPLACE FUNCTION core.get_system_property(p_property_name varchar(200))
RETURNS TABLE (
    id uuid,
...
CREATE OR REPLACE FUNCTION core.upsert_system_property(
    p_id uuid,
...
CREATE OR REPLACE FUNCTION core.insert_system_property_if_missing(
    p_id uuid,
    p_property_name varchar(200),
    p_property_value varchar(1000))
RETURNS TABLE (
