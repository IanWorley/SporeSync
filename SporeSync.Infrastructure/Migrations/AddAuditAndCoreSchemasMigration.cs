...
public sealed class AddAuditAndCoreSchemasMigration : Migration
{
    ...
    private const string UpPostFunctionPrefix = "SporeSync.Infrastructure.Migrations.Schema.Functions.202605260002_AddAuditAndCoreSchemas.Up.Post.";
    private const string DownPreFunctionPrefix = "SporeSync.Infrastructure.Migrations.Schema.Functions.202605260002_AddAuditAndCoreSchemas.Down.Pre.";
