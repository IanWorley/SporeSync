...
{
    private const string UpPostFunctionPrefix = "SporeSync.Infrastructure.Migrations.Schema.Functions.202607010001_AddRunLifecycleAndDeleteFunctions.Up.Post.";
    private const string DownPreFunctionPrefix = "SporeSync.Infrastructure.Migrations.Schema.Functions.202607010001_AddRunLifecycleAndDeleteFunctions.Down.Pre.";
