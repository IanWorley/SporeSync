...
public sealed class IncrementalGroupSyncMigration : Migration
{
    ...
    private const string UpPostFunctionPrefix = "SporeSync.Infrastructure.Migrations.Schema.Functions.202607110002_IncrementalGroupSync.Up.Post.";
    private const string DownPreFunctionPrefix = "SporeSync.Infrastructure.Migrations.Schema.Functions.202607110002_IncrementalGroupSync.Down.Pre.";
