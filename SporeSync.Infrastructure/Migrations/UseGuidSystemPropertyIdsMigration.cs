...
public sealed class UseGuidSystemPropertyIdsMigration : Migration
{
    ...
    private const string UpPreFunctionPrefix = "SporeSync.Infrastructure.Migrations.Schema.Functions.202605280002_UseGuidSystemPropertyIds.Up.Pre.";
    private const string UpPostFunctionPrefix = "SporeSync.Infrastructure.Migrations.Schema.Functions.202605280002_UseGuidSystemPropertyIds.Up.Post.";
    private const string DownPreFunctionPrefix = "SporeSync.Infrastructure.Migrations.Schema.Functions.202605280002_UseGuidSystemPropertyIds.Down.Pre.";
    private const string DownPostFunctionPrefix = "SporeSync.Infrastructure.Migrations.Schema.Functions.202605280002_UseGuidSystemPropertyIds.Down.Post.";
