...
import type { DownloadQueueItem, SporeSyncRun } from "../api/types";
...
function useDashboardSignalR(
  ...
  useEffect(() => {
    ...
    connection.on("RunUpdated", (run: SporeSyncRun) => {
